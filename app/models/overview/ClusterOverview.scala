...
object ClusterOverview {
  ...
  def apply(
      clusterState: JsValue,
      nodesStats: JsValue,
      indicesStats: JsValue,
      clusterSettings: JsValue,
      aliases: JsValue,
      clusterHealth: JsValue,
      nodesInfo: JsValue,
      indexingCompleteSettings: JsValue
  ): JsValue = {
  ...
  def buildIndices(clusterState: JsValue, indicesStats: JsValue, aliases: JsValue, indexingCompleteSettings: JsValue): Seq[JsValue] = {
    ...
    val completed = indexingCompleteSettings
      .as[JsObject]
      .value
      .collect {
